...
function MiniNavbar() {
  ...
  const loginButtonElement = (
    <Link to="/auth/login" className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto text-center">
      LogIn
    </Link>
  );
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
       ...
       <Link to="/dashboard" className="relative z-10 block px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto text-center">
         Launch
       </Link>
    </div>
  );
