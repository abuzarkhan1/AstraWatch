...
function ServiceSLO({ svc }: { svc: any }) {
  ...
  return (
    <div className="bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900 border border-neutral-800 text-white rounded-2xl p-6 shadow-xl space-y-3 hover:border-blue-500/40 transition-colors">
