      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-400 font-mono">{trace.traceId.substring(0, 16)}...</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Badge variant="secondary">{trace.spanCount} spans</Badge>
                      <Badge variant="secondary">{trace.serviceCount} services</Badge>
                    </div>
                  </div>
        ...
        <div className="lg:col-span-1">
          {selectedTrace ? (
            <Card>
              <CardHeader>
                <CardTitle className="text-sm">Trace Detail</CardTitle>
              </CardHeader>
              <CardContent>
