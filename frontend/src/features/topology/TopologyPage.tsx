  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4">
        <div className="flex-1 bg-gray-900 rounded-lg border border-gray-800" style={{ height: 600 }}>
          {isLoading ? (
        ...
        {data && (
          <div className="w-72 bg-gray-900 rounded-lg border border-gray-800 p-4 space-y-3">
